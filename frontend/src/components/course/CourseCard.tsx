        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between text-sm text-gray-500">
            <span className="flex items-center">
              ...
              {course._count?.lessons || 0} {t('common:lesson', { count: course._count?.lessons || 0 })}
            </span>
            ...
            {course.estimatedHours && (
              <span className="flex items-center">
                ...
                {course.estimatedHours}{t('common:hour', { count: course.estimatedHours }).charAt(0)}
              </span>
            )}
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-gray-500">
              {course._count?.userProgress || 0} {t('common:enrolled', { count: course._count?.userProgress || 0 })}
            </span>
          </div>
